...
export function PortfolioHero() {
  ...
  const description = heroContent.description || "Creating beautiful digital experiences that blend creativity with functionality. Specializing in UI/UX design for modern web and mobile applications.";
      ...
      <div className="relative max-w-7xl mx-auto w-full py-16 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 text-center lg:text-left order-2 lg:order-1">
            ...
            >
              <p className="text-purple-400 tracking-[0.3em] uppercase text-xs font-medium">
                {greeting}
              </p>
            </motion.div>
            ...
            >
              <p className="text-base md:text-lg text-gray-400 max-w-[550px] leading-[1.6]">
                {description}
              </p>
            </motion.div>
